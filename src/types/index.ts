...
export interface Workday { id:string; companyId:string; userId:string; date:string; status?:WorkStatus; clockInAt?:Timestamp; breakStartAt?:Timestamp; breakEndAt?:Timestamp; clockOutAt?:Timestamp; totalWorkedMinutes:number; totalBreakMinutes:number }
